...
ALTER TABLE "{{esquema}}"."mavvial_fin" ADD COLUMN IF NOT EXISTS id serial;
...
select id, geom, placa,id_mavvial from "{{esquema}}"."placa"
...
alter table "{{esquema}}"."mavvial_fin" drop column if exists swap;
alter table "{{esquema}}"."mavvial_fin" add column swap varchar;

update "{{esquema}}"."mavvial_fin" v
set swap = 'si'
...
alter table "{{esquema}}"."mavvial_fin" drop column if exists id_grupo_swap;
alter table "{{esquema}}"."mavvial_fin" add column id_grupo_swap integer;
...
ALTER TABLE "{{esquema}}"."mavvial_fin" drop COLUMN if exists swap_grupal;
ALTER TABLE "{{esquema}}"."mavvial_fin" ADD COLUMN swap_grupal text;
...
ALTER TABLE "{{esquema}}"."mavvial_fin" drop COLUMN if exists swap;
ALTER TABLE "{{esquema}}"."mavvial_fin" drop COLUMN if exists id_grupo_swap;
ALTER TABLE "{{esquema}}"."mavvial_fin" rename column swap_grupal to swap;
