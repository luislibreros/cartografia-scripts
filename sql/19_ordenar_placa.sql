...
ALTER TABLE "32_es"."placa" ADD COLUMN IF NOT EXISTS id serial;
...
alter table "32_es"."placa" add column ordenamiento_placa varchar;

update "32_es"."placa" o
...
UPDATE "28_se"."placa"
SET 
    lat_procesada  = ST_Y(geom),
    long_procesada = ST_X(geom)
WHERE geom IS NOT NULL;

DO $$
BEGIN
    RAISE NOTICE 'Campos lat_procesada y long_procesada calculados correctamente.';
END $$;
