...
UPDATE "50_ms".mavvial_fin SET validar_swap = 0;
...
DROP TABLE IF EXISTS "50_ms".mavvial_fin_backup;
CREATE TABLE "50_ms".mavvial_fin_backup AS 
SELECT * FROM "50_ms".mavvial_fin;
