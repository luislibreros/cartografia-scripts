...
select geom, id_capa, nomvtotal from "50_ms"."mavvial_fin";
...
alter table "50_ms"."placa" drop column if exists geom_ajustada;
alter table "50_ms"."placa" add column geom_ajustada geometry;

alter table "50_ms"."placa" drop column if exists observ_ajuste;
alter table "50_ms"."placa" add column observ_ajuste varchar;

UPDATE "50_ms"."placa" p
...
alter table "50_ms"."placa" drop column geom_ajustada;
